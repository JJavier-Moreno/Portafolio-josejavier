...
const Tecnologias = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between w-full gap-4 mt-10 md:mt-20 md:flex-row md:px-20">
      <h3 className="flex flex-col text-left whitespace-nowrap">
